...
export function Footer() {
  ...
  return (
    <footer className="bg-black py-12 border-t border-amber-500/20 relative overflow-hidden">
      {/* Animated Barber Pole Stripe */}
      <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-amber-400 via-red-500 to-blue-500 animate-pulse"></div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-3 mb-6 md:mb-0">
            ...
            <div>
              ...
              <div className="text-sm text-gray-400">{t("Footer.subtitle")}</div>
            </div>
          </div>
          ...
          <div className="flex space-x-6">
            <a
              href="#"
              className="w-12 h-12 bg-zinc-800 hover:bg-amber-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
            >
